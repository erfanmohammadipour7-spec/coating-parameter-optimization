...
from optimizer import find_minimum_grid_search, find_minimum_gradient_descent
...
# --- 5. Train Final Model for Visualization and Optimization ---
...
# --- 7. Find Optimal Input Parameters ---
# Method 1: Grid Search
grid_search_results = find_minimum_grid_search(final_model, final_scaler, original_df, INPUT_COLS, OUTPUT_COLS)
print("\n-----------------------------------------")
print("           Optimization Results          ")
print("-----------------------------------------")
print("[Grid Search Method]")
print(f"Optimal Inputs:")
for key, val in grid_search_results['optimal_inputs'].items():
    print(f"  - {key}: {val:.2f}")
print(f"Predicted Outputs at Minimum:")
for key, val in grid_search_results['predicted_outputs'].items():
    print(f"  - {key}: {val:.4f}")
print("-----------------------------------------")

# Method 2: Gradient Descent
gradient_search_results = find_minimum_gradient_descent(final_model, final_scaler, OUTPUT_COLS)
print("[Gradient Descent Method]")
print(f"Optimal Inputs:")
for key, val in gradient_search_results['optimal_inputs'].items():
    print(f"  - {key}: {val:.2f}")
print(f"Predicted Outputs at Minimum:")
for key, val in gradient_search_results['predicted_outputs'].items():
    print(f"  - {key}: {val:.4f}")
print("-----------------------------------------")
